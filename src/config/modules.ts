...
export const MODULES: ModuleDefinition[] = [
  {
    ...
    name: "Command Center",
    short: "COMMAND",
    description: "Cixy executive headquarters",
    route: "/command",
    category: "core",
    accent: "#f4b942",
    glyph: "◈",
  },
  {
    id: "crypto",
    slug: "crypto-floor",
    name: "The Crypto Floor",
    short: "CRYPTO",
    description: "Autonomous paper-trading floor",
    route: "/crypto-floor",
    category: "core",
    accent: "#4cd9ff",
    glyph: "₿",
  ...
  },
  {
    ...
    name: "Socixis",
    short: "SOCIXIS",
    description: "AI marketing and social",
    route: "/projects/socixis",
    category: "company",
    accent: "#8758ff",
    fleetSlug: "socixis",
  ...
  },
  {
    ...
    name: "Contraxis",
    short: "CONTRAXIS",
    description: "Homeowners and contractors matched with AI",
    route: "/projects/contraxis",
    category: "company",
    accent: "#f4b942",
    fleetSlug: "contraxis",
  ...
  },
  {
    ...
    name: "Halaxis",
    short: "HALAXIS",
    description: "Halal and Sharia-compliant fund",
    route: "/projects/halaxis",
    category: "company",
    accent: "#37e681",
    fleetSlug: "halaxis",
  ...
  },
  {
    ...
    name: "Lyrixis",
    short: "LYRIXIS",
    description: "Music metadata and catalog intelligence",
    route: "/projects/lyrixis",
    category: "company",
    accent: "#ff5353",
    fleetSlug: "lyrixis",
  ...
  },
  {
    ...
    name: "AwadBot",
    short: "AWADBOT",
    description: "Personal financier",
    route: "/projects/awadbot",
    category: "company",
    accent: "#4cd9ff",
    fleetSlug: "awadbot",
    url: "https://awadbot.vercel.app",
    glyph: "◇",
  },
  {
    id: "qahwahworld",
    ...
    name: "Qahwahworld",
    short: "QAHWAH",
    description: "Specialty coffee marketplace",
    route: "/projects/qahwahworld",
    category: "company",
    accent: "#f4b942",
    fleetSlug: "qahwahworld",
    url: "https://qahwahworld.vercel.app",
    glyph: "☕",
  },
  {
    id: "recovra",
    ...
    name: "Recovra",
    short: "RECOVRA",
    description: "Overcharge recovery for companies",
    route: "/projects/recovra",
    category: "company",
    accent: "#37e681",
    fleetSlug: "recovra",
  ...
  },
  {
    ...
    name: "Geoxis",
    short: "GEOXIS",
    description: "Live 3D map of company movement",
    route: "/projects/geoxis",
    category: "company",
    accent: "#3c8dff",
    fleetSlug: "geoxis",
  ...
  },
  {
    ...
    name: "Launchixis",
    short: "LAUNCH",
    description: "Launch ops for new family companies",
    route: "/projects/launchixis",
    category: "company",
    accent: "#8758ff",
    fleetSlug: "launchixis",
  ...
  },
  {
    ...
    name: "Nursery Toons",
    short: "TOONS",
    description: "Kids cartoons and nursery content",
    route: "/projects/nursery-toons",
    category: "company",
    accent: "#ff5353",
    fleetSlug: "nursery-toons",
    url: "https://nurserytoons.vercel.app",
    glyph: "★",
  },
  {
    id: "content",
    ...
    name: "Content Studio",
    short: "CONTENT",
    description: "One-minute social videos",
    route: "/content",
    category: "studio",
    accent: "#8758ff",
    fleetSlug: "contentbot",
    url: "https://personalcontentbot.vercel.app",
    glyph: "▶",
  },
  {
    id: "books",
    ...
    name: "Books & Media",
    short: "BOOKS",
    description: "KDP and publishing",
    route: "/books",
    category: "studio",
    accent: "#f4b942",
    glyph: "▤",
  },
  {
    ...
    name: "Analytics",
    short: "ANALYTICS",
    description: "Cross-company metrics",
    route: "/analytics",
    category: "system",
    accent: "#4cd9ff",
    glyph: "▥",
