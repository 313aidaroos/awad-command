...
| `src/app/api/mail/accounts/route.ts` | Part of: Change notes inside each changed backend file. |
| `src/app/api/mail/callback/[provider]/route.ts` | Part of: Change notes inside each changed backend file. |
| `src/app/api/mail/connect/[provider]/route.ts` | Part of: Change notes inside each changed backend file. |
| `src/app/api/mail/draft/route.ts` | Part of: Change notes inside each changed backend file. |
| `src/app/api/mail/inbox/route.ts` | Part of: Change notes inside each changed backend file. |
| `src/app/api/mail/send/route.ts` | Part of: Change notes inside each changed backend file. |
| `src/app/api/mission-control/route.ts` | Part of: Change notes inside each changed backend file. |
| `src/app/api/wallet/summary/route.ts` | Part of: Change notes inside each changed backend file. |
...
| `src/ceo/applyClientActions.ts` | Part of: Change notes inside each changed backend file. |
| `src/ceo/buildContext.ts` | Part of: Change notes inside each changed backend file. |
| `src/ceo/runCeoTurn.ts` | Part of: Change notes inside each changed backend file. |
| `src/ceo/tools.ts` | Part of: Change notes inside each changed backend file. |
| `src/ceo/tools.types.ts` | Part of: Change notes inside each changed backend file. |
...
| `src/landing/useLandingData.ts` | Part of: Change notes inside each changed backend file. |
| `src/lib/apixis-wallet.ts` | Part of: Change notes inside each changed backend file. |
| `src/lib/branding.test.ts` | Test added or updated to match. |
| `src/lib/ceoBridge.ts` | Part of: Change notes inside each changed backend file. |
| `src/lib/dashboardData.ts` | Part of: Change notes inside each changed backend file. |
| `src/lib/mail/accounts.ts` | Part of: Change notes inside each changed backend file. |
| `src/lib/mail/crypto.ts` | Part of: Change notes inside each changed backend file. |
| `src/lib/mail/format.ts` | Part of: Change notes inside each changed backend file. |
| `src/lib/mail/google.ts` | Part of: Change notes inside each changed backend file. |
| `src/lib/mail/http.ts` | Part of: Change notes inside each changed backend file. |
| `src/lib/mail/mail.test.ts` | Test added or updated to match. |
| `src/lib/mail/microsoft.ts` | Part of: Change notes inside each changed backend file. |
| `src/lib/mail/oauth.ts` | Part of: Change notes inside each changed backend file. |
| `src/lib/mail/types.ts` | Part of: Change notes inside each changed backend file. |
| `src/lib/missionControl.support.test.ts` | Test added or updated to match. |
| `src/lib/missionControl.ts` | Part of: Change notes inside each changed backend file. |
| `src/lib/payments.ts` | Part of: Change notes inside each changed backend file. |
| `src/lib/supabase/middleware.ts` | Part of: Change notes inside each changed backend file. |
| `src/lib/walletEmbed.ts` | Part of: Change notes inside each changed backend file. |
| `src/lib/walletStats.test.ts` | Test added or updated to match. |
| `src/lib/walletStats.ts` | Part of: Change notes inside each changed backend file. |
| `src/projects/teams.test.ts` | Test added or updated to match. |
| `src/projects/teams.ts` | Part of: Change notes inside each changed backend file. |
